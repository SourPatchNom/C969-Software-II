...
namespace OwlSchedulerLibrary.OwlDatabase
{
    public static class DatabaseDebugTools
    {
        ...
        public static void PopulateWithData()
        {
            ...
            DatabaseHandler.Instance.InsertAppointment(new Appointment(-1,1,1,"Day 1 A","Lorem Ipsum","Facetime","Billy Bob","Virtual","http://debug.com/",DateTime.Now.Date.AddHours(0).AddHours(8).AddMinutes(0),DateTime.Now.Date.AddHours(0).AddHours(8).AddMinutes(15),DateTime.UtcNow, "Admin", DateTime.UtcNow, "Admin"));
            DatabaseHandler.Instance.InsertAppointment(new Appointment(-1,1,1,"Day 1 B","Lorem Ipsum","Facetime","Billy Bob","Virtual","http://debug.com/",DateTime.Now.Date.AddHours(0).AddHours(9).AddMinutes(0),DateTime.Now.Date.AddHours(0).AddHours(9).AddMinutes(15),DateTime.UtcNow, "Admin", DateTime.UtcNow, "Admin"));
