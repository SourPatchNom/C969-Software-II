...
namespace Owl_Scheduler_Desktop_Edition.ManageCustomerWindows
{
    public partial class ManageAddressWindow : Window
    {
        ...
        public ManageAddressWindow()
        {
            ...
            ComboBoxCityPicker.ItemsSource = OwlScheduler.Instance.CustomerDataModel.Cities;
        }
        ...
        private void ValidateInputData()
        {
            ...
            if (!OwlSchedulerLibrary.OwlSchedule.Helpers.CustomerDataFormatCheck.CorrectFormatCustomerPhone(TextBoxPhone.Text, out string result))
            {
            ...
            if (!OwlSchedulerLibrary.OwlSchedule.Helpers.CustomerDataFormatCheck.CorrectFormatCustomerAddressOne(TextBoxAddressLineOne.Text, out result))
            {
                LabelErrors.Content = result;
                LabelErrors.Visibility = Visibility.Visible;
                UpdateSaveButton(false);
            ...
            if (!OwlSchedulerLibrary.OwlSchedule.Helpers.CustomerDataFormatCheck.CorrectFormatCustomerAddressTwo(TextBoxAddressLineTwo.Text, out result))
            {
                LabelErrors.Content = result;
                LabelErrors.Visibility = Visibility.Visible;
                UpdateSaveButton(false);
            ...
            if (!OwlSchedulerLibrary.OwlSchedule.Helpers.CustomerDataFormatCheck.CorrectFormatCustomerPostal(TextBoxPostalLine.Text, out result))
            {
                LabelErrors.Content = result;
                LabelErrors.Visibility = Visibility.Visible;
                UpdateSaveButton(false);
        ...
        private void PopulateData()
        {
            ...
            var city = OwlScheduler.Instance.CustomerDataModel.Cities.FirstOrDefault(x => x.CityId == address.CityId);
        ...
        private void ComboBoxCityPicker_OnSelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            ...
            var countryName = OwlScheduler.Instance.CustomerDataModel.Countries.FirstOrDefault(x => x.CountryId == ((City)ComboBoxCityPicker.SelectedItem).Country)?.CountryName;
