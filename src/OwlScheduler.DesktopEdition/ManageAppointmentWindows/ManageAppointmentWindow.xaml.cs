...
using OwlScheduler.Library.OwlSchedule.Helpers;

namespace OwlScheduler.DesktopEdition.ManageAppointmentWindows
{
    public partial class ManageAppointmentWindow : Window
    {
        ...
        public ManageAppointmentWindow()
        {
            ...
            ComboAppointmentPicker.ItemsSource = Library.OwlSchedule.OwlScheduler.Instance.AppointmentDataModel.CurrentUserAppointmentsMaster;
            ComboAppointmentPicker.MaxDropDownHeight = 200;
            ComboCustomerPicker.ItemsSource = Library.OwlSchedule.OwlScheduler.Instance.CustomerDataModel.Customers;
            ...
            ComboBoxStartHour.ItemsSource =  Enumerable.Range(Library.OwlSchedule.OwlScheduler.BusinessHourOpen, Library.OwlSchedule.OwlScheduler.BusinessHourClose - Library.OwlSchedule.OwlScheduler.BusinessHourOpen);
        ...
        private void SaveButton_OnClick(object sender, RoutedEventArgs e)
        {
            ...
            bool saved = Library.OwlSchedule.DataModel.AppointmentDataModify.SaveAppointment(new Appointment(_editMode ? (((Appointment)ComboAppointmentPicker.SelectedItem).AppointmentId) : -1,
        ...
        private void DeleteButton_OnClick(object sender, RoutedEventArgs e)
        {
            ...
            if (Library.OwlSchedule.DataModel.AppointmentDataModify.DeleteAppointment(((Appointment)ComboAppointmentPicker.SelectedItem).AppointmentId, out var result))
            {
        ...
        private void PopulateFieldInfo()
        {
            ...
            ComboCustomerPicker.SelectedItem = Library.OwlSchedule.OwlScheduler.Instance.CustomerDataModel.Customers.First(x => x.CustomerId == appointment.CustomerId);
