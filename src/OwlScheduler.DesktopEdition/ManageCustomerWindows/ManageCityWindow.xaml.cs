...
namespace OwlScheduler.DesktopEdition.ManageCustomerWindows
{
    public partial class ManageCityWindow : Window
    {
        ...
        public ManageCityWindow()
        {
            ...
            InitializeComponent();
            ComboCityPicker.ItemsSource = Library.OwlSchedule.OwlScheduler.Instance.CustomerDataModel.Cities;
            ComboCityPicker.MaxDropDownHeight = 200;
            ComboBoxCountryPicker.ItemsSource = Library.OwlSchedule.OwlScheduler.Instance.CustomerDataModel.Countries;
        ...
        private void PopulateData()
        {
            ...
            ComboBoxCountryPicker.SelectedItem = Library.OwlSchedule.OwlScheduler.Instance.CustomerDataModel.Countries.FirstOrDefault(x => x.CountryId == city.Country);
            ValidateInputFields();
        }
        ...
        private void ValidateInputFields()
        {
            ...
            if (!Library.OwlSchedule.Helpers.CustomerDataFormatCheck.CorrectFormatCustomerCity(TextBoxCityName.Text, out string result))
            {
